...
function runLabel(type){return({functional:'Functional Smoke',api_soak:'API Soak',browser_visual:'Browser Visual',factory_simulation:'Factory Lifecycle',realtime_soak:'Mô phỏng nhiều ngày'})[type]||type}
